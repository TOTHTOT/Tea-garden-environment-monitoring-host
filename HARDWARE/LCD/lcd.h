...
//LCD屏幕状态
extern u8 LCD_Sta;
void Control_screen_on_off(u8 on_off);
//////////////////////////////////////////////////////////////////////////////////	  
//定义LCD的尺寸
#define LCD_W 240
#define LCD_H 320
...
////////////////////////////////////////////////////////////////////
//-----------------LCD端口定义---------------- 
#define GPIO_TYPE_B  GPIOB  //GPIO组类型
#define GPIO_TYPE_A GPIOA
#define LED      9        //背光控制引脚        PB9
#define LCD_CS   8       //片选引脚            PA8
#define LCD_RS   8       //寄存器/数据选择引脚 PB8 
...
//GPIO置位（拉高）
#define	LCD_CS_SET  GPIO_TYPE_A->BSRR=1<<LCD_CS    //片选端口  	    PA8
#define	LCD_RS_SET	GPIO_TYPE_B->BSRR=1<<LCD_RS    //数据/命令      PB8	  
#define	LCD_RST_SET	GPIO_TYPE_B->BSRR=1<<LCD_RST   //复位			  PB12

//GPIO复位（拉低）							    
#define	LCD_CS_CLR  GPIO_TYPE_A->BRR=1<<LCD_CS    //片选端口  	  PA8
#define	LCD_RS_CLR	GPIO_TYPE_B->BRR=1<<LCD_RS     //数据/命令    PB8	 
#define	LCD_RST_CLR	GPIO_TYPE_B->BRR=1<<LCD_RST    //复位		  PB12
