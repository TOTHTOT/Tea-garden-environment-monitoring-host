...
extern u8 cursor_pos;			//光标位置

//与触摸屏芯片连接引脚	   
//与触摸屏芯片连接引脚	   
#define PEN  PAin(4)    //PC10  INTl
#define DOUT PAin(1)     //PC2  MISO		 PC2--PB14
#define TDIN PCout(15)    //PC3  MOSI		 PC3--PB15
#define TCLK PAout(5)    //PA5  SCLK	 PC0--PB13
#define TCS  PCout(14)   //PC13 CS    
     

//保存的设置信息位置
#define AT24CXX_SLAVE_NUM_ADDR 1				//从机数量保存地址
#define AT24CXX_SLAVE_ADDR_ADDR 60				//从机地址及信道保存地址
#define AT24CXX_MASTER_QUERY_INTERVAL_TIME 2	//主机轮询间隔保存地址
#define AT24CXX_MASTER_SCREEN_ON_TIME 3			//主机屏幕息屏时间保存地址
